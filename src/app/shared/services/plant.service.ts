...
export class PlantService {
    ...
    private plantsArray : Plant[] = [
        ...
        new Plant('Ceratoptens thalictroides', 'Vesisaniainen', new OptimalWater(5, 8.5, 0, 20, 22, 28)),
        ...
        new Plant('Myriophyllum tuberculatum', 'Ruosteäeviä', new OptimalWater(6.5, 7.5, 2, 10, 22, 28)),
